...
try:
    elem = input("Qué elemento quieres borrar?: ")

    # Borramos buscando la posición del elemento
    i = l3.index(elem) # Buscamos el índice donde se encuentra el elemento "Violeta"
    print("El elemento ", elem, " se encuentra en el índice: ", i)
    l3.pop(i) # Borramos el elemento

    # o Borramos directamente con el método "remove"
    #l3.remove(elem)

    print("Lista tras borrar el elemento ", elem, ": ", l3)
except:
